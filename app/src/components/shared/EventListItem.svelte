...
<a
  class="flex flex-col justify-between rounded-md border border-black px-3 py-4 hover:bg-[#E5FFE3] hover:transition-[2s] sm:flex-row dark:border-white dark:hover:bg-zinc-800"
