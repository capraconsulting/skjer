<script lang="ts">
  ...
  import capraLogoBlack from "$lib/assets/capra-black-small.webp";
  import frydeLogoBlack from "$lib/assets/fryde-black-small.webp";
  import lifligLogoBlack from "$lib/assets/liflig-black-small.webp";
